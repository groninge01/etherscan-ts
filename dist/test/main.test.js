...
describe("etherscan-ts Test", () => {
    ...
    test("getTrxList", async () => {
        const res = await etherscan.getTrxList(address, startblock, endblock, page, offset, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getInternalTrxListByAddress", async () => {
        const res = await etherscan.getInternalTrxListByAddress(address, startblock, endblock, page, offset, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    ...
    test("getInternalTrxListByBlockRange", async () => {
        const res = await etherscan.getInternalTrxListByBlockRange(startblock, endblock, page, offset, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getERC20TokenTransferEventList", async () => {
        const res = await etherscan.getERC20TokenTransferEventList(address, contractAddress, startblock, endblock, page, offset, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getERC721TokenTransferEventList", async () => {
        const res = await etherscan.getERC721TokenTransferEventList(address, contractAddress, startblock, endblock, page, offset, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getERC1155TokenTransferEventList", async () => {
        const res = await etherscan.getERC1155TokenTransferEventList(address, contractAddress, startblock, endblock, page, offset, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getMinedBlocksByAddress", async () => {
        const res = await etherscan.getMinedBlocksByAddress(address, blocktype, page, offset);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    ...
    test("getBlockNumberByTimestamp", async () => {
        const res = await etherscan.getBlockNumberByTimestamp(timestamp, closest);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyAverageBlockSize", async () => {
        const res = await etherscan.getDailyAverageBlockSize(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyAverageBlockCountAndRewards", async () => {
        const res = await etherscan.getDailyAverageBlockCountAndRewards(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyBlockRewards", async () => {
        const res = await etherscan.getDailyBlockRewards(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyAverageBlockTime", async () => {
        const res = await etherscan.getDailyAverageBlockTime(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyUncleBlockCountAndRewards", async () => {
        const res = await etherscan.getDailyUncleBlockCountAndRewards(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getEventLogsByAddress", async () => {
        const res = await etherscan.getEventLogsByAddress(address, fromBlock, toBlock, page, offset);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getEventLogsByTopics", async () => {
        const res = await etherscan.getEventLogsByTopics(fromBlock, toBlock, topic0, topic0_1_opr, topic1, page, offset);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getEventLogsByAddressFilteredByTopics", async () => {
        const res = await etherscan.getEventLogsByAddressFilteredByTopics(fromBlock, toBlock, address, topic0, topic0_1_opr, topic1, page, offset);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    ...
    test("getTransactionByBlockNumberAndIndex", async () => {
        const res = await etherscan.getTransactionByBlockNumberAndIndex(tag, index);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    ...
    test("getERC20TokenBalance", async () => {
        const res = await etherscan.getERC20TokenBalance(contractaddress, address, tag);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getHistoricalERC20TokenTotalSupplyByContractAddressAndBlockNo", async () => {
        const res = await etherscan.getHistoricalERC20TokenTotalSupplyByContractAddressAndBlockNo(contractaddress, blockno);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getHistoricalERC20TokenBalanceByContractAddressAndBlockNo", async () => {
        const res = await etherscan.getHistoricalERC20TokenBalanceByContractAddressAndBlockNo(contractaddress, address, blockno);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getTokenInfoByContractAddress", async () => {
        const res = await etherscan.getTokenInfoByContractAddress(contractaddress);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getAddressERC721TokenInventoryByContractAddress", async () => {
        const res = await etherscan.getAddressERC721TokenInventoryByContractAddress(address, contractaddress, page, offset);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    ...
    test("getEthereumDailyTotalGasUsed", async () => {
        const res = await etherscan.getEthereumDailyTotalGasUsed(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyAverageGasPrice", async () => {
        const res = await etherscan.getDailyAverageGasPrice(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyAverageGasLimit", async () => {
        const res = await etherscan.getDailyAverageGasLimit(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    ...
    test("getEtherNodesSize", async () => {
        ...
        const res = await etherscan.getEtherNodesSize(startdate, enddate, clienttype, syncmode, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    ...
    test("getDailyNetworkTrxFee", async () => {
        const res = await etherscan.getDailyNetworkTrxFee(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyNewAddressCount", async () => {
        const res = await etherscan.getDailyNewAddressCount(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyNetworkUtilization", async () => {
        const res = await etherscan.getDailyNetworkUtilization(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getDailyAverageNetworkHashRate", async () => {
        const res = await etherscan.getDailyAverageNetworkHashRate(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    ...
    test("getDailyAverageNetworkDifficulty", async () => {
        const res = await etherscan.getDailyAverageNetworkDifficulty(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getEtherHistoricalDailyMarketCap", async () => {
        const res = await etherscan.getEtherHistoricalDailyMarketCap(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
    test("getEtherHistoricalPrice", async () => {
        const res = await etherscan.getEtherHistoricalPrice(startdate, enddate, sort);
        expect(res.status).toBe("1");
        expect(res.message).toBe("OK");
    });
});
